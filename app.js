...
const btnDescargar = document.querySelector("#button-descarga");

btnDescargar.addEventListener("click", () => {
  domtoimage
    .toBlob(document.querySelector("#caja-meme"))
    .then((Blob) => saveAs(Blob, "mi-meme.jpg"));
});

// ********************************************************
// CAMBIO DE COLUMNA IMAGEN A COLUMNA TEXTO CON BOTONES NAV | BOTON CIERRE RESPONSIVE
// ********************************************************
let btnImagen = document.querySelector("#button-text-img");
let btnText = document.querySelector("#button-text-text");
let panelImagen = document.querySelector("#panel-imagen");
let panelTexto = document.querySelector("#panel-texto");
let btnPanelCierrre = document.querySelector("#panel-close-button");
...
url.addEventListener('input',()=>{
    imagen.style = `background-image: url(${url.value})`
